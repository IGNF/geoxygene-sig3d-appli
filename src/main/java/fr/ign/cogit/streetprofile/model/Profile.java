...
public class Profile {
	...
	public void updateDisplay() {
		...
		carte.addLayer(new VectorLayer(featOrthoColl, "Vecteur Ortho", new Color(155, 2, 200)));

		carte.addLayer(new VectorLayer(batibati, "batiments proches"));
		carte.addLayer(new VectorLayer(batibati1, "batiments proches1"));

		carte.addLayer(new VectorLayer(RoofDetection.detectRoof(bati, 0.2, true), "Toits", Color.yellow));
